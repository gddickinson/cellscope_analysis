# Contributing to cellscope_analysis
...
[GitHub issue](https://github.com/gddickinson/cellscope_analysis/issues) rather than emailing —
...
2. **What happened** versus what you expected. Paste the full traceback if there
   was one.
3. **Your data** — the CellScope run that produced the masks (attach its `RUN_METADATA.json` if you have it), and the shape of the `masks.npz` you loaded.

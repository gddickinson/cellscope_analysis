...
# Configurable analysis options + tunable parameters live in analysis_params.py;
# re-exported here so existing `compare_tables` importers keep working.
from .analysis_params import (  # noqa: F401
    COMPARE_OPTIONS, ANALYSIS_PARAMS, ANALYSIS_CHOICES, compare_options,
    analysis_params, analysis_choices, apply_analysis_params, analysis_params_tag)
    ...
    def run(self):
        ...
        try:
            res = compare.build_comparison(
                ...
                with_contacts=o.get("contacts", False),
                with_state_segmented=o.get("state_segmented", False),
